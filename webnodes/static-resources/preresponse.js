    ...
    if(!negotiator.isAjax()) {
        ...
        if (response.isBoom) {
            ...
            if(response.output.statusCode === 404) {
                ...
                return reply.view('404', data, {layout: 'page_layout'}).code(response.output.statusCode);
            } else {
                console.error(response.stack);
                return reply.view('500', data, {layout: 'page_layout'}).code(response.output.statusCode);
            }
        }
    }
